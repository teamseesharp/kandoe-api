...
namespace WebApi.Tests.Filters.Authorization {
    ...
    public class AuthorizeOrganiserAttributeTest {
        ...
        public static IEnumerable AuthorizationCases {
            get {
                yield return new TestCaseData("POST", "Subtheme", new SubthemeDto { Name = "name", OrganiserId = 1, ThemeId = 1 });
                ...
                yield return new TestCaseData("POST", "Session",
                    new SessionDto {
                        ...
                        IsFinished = false, MaxCardsToChoose = 10, MaxParticipants = 10,
                        Round = 1, SubthemeId = 1, Start = DateTime.Now, End = DateTime.Now.AddDays(6)
                    });
