    ...
    public partial class Initial : DbMigration {
        public override void Up() {
            ...
            CreateTable(
                "dbo.InvitedSessions",
                c => new {
                    InvitedId = c.Int(nullable: false),
                    InvitedSessionId = c.Int(nullable: false),
                })
                .PrimaryKey(t => new { t.InvitedId, t.InvitedSessionId })
                .ForeignKey("dbo.Accounts", t => t.InvitedId)
                .ForeignKey("dbo.Sessions", t => t.InvitedSessionId)
                .Index(t => t.InvitedId)
                .Index(t => t.InvitedSessionId);
        ...
        public override void Down() {
            ...
            DropForeignKey("dbo.InvitedSessions", "InvitedSessionId", "dbo.Sessions");
            DropForeignKey("dbo.InvitedSessions", "InvitedId", "dbo.Accounts");
            ...
            DropIndex("dbo.InvitedSessions", new[] { "InvitedSessionId" });
            DropIndex("dbo.InvitedSessions", new[] { "InvitedId" });
